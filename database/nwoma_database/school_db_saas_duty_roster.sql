...
CREATE TABLE `duty_roster` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `duty_roster_ibfk_1` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE CASCADE,
  CONSTRAINT `duty_roster_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
