...
CREATE TABLE `term_summaries` (
  ...
  `aggregate_score` decimal(10,2) DEFAULT NULL,
  ...
  KEY `term_id` (`term_id`),
  CONSTRAINT `term_summaries_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE,
  CONSTRAINT `term_summaries_ibfk_2` FOREIGN KEY (`term_id`) REFERENCES `academic_terms` (`id`) ON DELETE CASCADE
...
LOCK TABLES `term_summaries` WRITE;
/*!40000 ALTER TABLE `term_summaries` DISABLE KEYS */;
/*!40000 ALTER TABLE `term_summaries` ENABLE KEYS */;
UNLOCK TABLES;
